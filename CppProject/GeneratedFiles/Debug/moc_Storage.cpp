...
QT_MOC_LITERAL(3, 20, 10), // "requestKey"
QT_MOC_LITERAL(4, 31, 6), // "getRom"
QT_MOC_LITERAL(5, 38, 8), // "writeKey"
QT_MOC_LITERAL(6, 47, 4) // "byte"

    },
    "Storage\0getRomComp\0\0requestKey\0getRom\0"
    "writeKey\0byte"
};
...
void Storage::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->requestKey((*reinterpret_cast< bool(*)>(_a[1]))); break;
        case 2: _t->getRom((*reinterpret_cast< QString(*)>(_a[1]))); break;
        case 3: _t->writeKey((*reinterpret_cast< byte(*)>(_a[1]))); break;
        default: ;
        }
        ...
        {
            typedef void (Storage::*_t)(bool );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Storage::requestKey)) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 1
void Storage::requestKey(bool _t1)
{
